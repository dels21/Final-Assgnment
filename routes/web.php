...
Route::middleware(['auth', 'paid'])->group(function () {
    ...
    Route::post('/add-coins', [UserController::class, 'addCoins'])->name('user.addCoins');
    Route::put('/user-avatar/{avatar}/update-profile', [UserAvatarController::class, 'updateProfile'])->name('user-avatar.update-profile');
});
